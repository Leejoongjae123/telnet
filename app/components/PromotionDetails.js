  ...
  return (
    <>
          ...
          <div className="w-full h-1/4 flex justify-center items-center">
            <div className="w-[80%] h-[80%] relative z-50 flex justify-center items-center">
              ...
              >
                ...
                />
                <p className="text-lg md:text-[35px] relative z-20">
                  인터넷+TV
                </p>
                <img
                  src="/rightup.png"
                  alt=""
                  className="absolute right-[-20%] top-[-100%] w-10 h-10 md:w-18 md:h-18 -z-10"
                />
              </div>
            </div>
          </div>
          <div className="w-full h-full flex flex-col justify-center items-center text-center">
            ...
            >
              <img
                src="/light.png"
                alt=""
                className="w-16 h-16 absolute left-[20%] top-[-80%] md:top-[-10%] z-10"
              />
              <div className="text-2xl md:text-[45px] text-white mb-2 md:mb-12 mt-2 md:mt-0">
                현금{" "}
                <span className="text-[34px] md:text-[65px] text-[#1E96FC] rainbow-text animate-rainbow">
                  48만원
                </span>
              </div>
              <div className="text-2xl md:text-[45px] text-white ">
                +
                <span style={{ 
                  textShadow: `-1px -1px 0 black,  
                              1px -1px 0 black,
                              ...
                              5px 5px 0 black`,
                  fontFamily: "PartialSansKR",
                }} className="text-[34px] md:text-[65px] rainbow-text animate-rainbow">
                  비밀지원금
                </span>
              </div>
              <img
      ...
      <div className="w-full h-full flex flex-row bg-amber-300 p-4 md:p-8">
        <div className="w-3/5 h-full flex justify-evenly items-center gap-x-4">
          <img
            src="/sk.png"
            alt=""
