          ...
          >
            <p>
              <span
                ...
                className="text-[#1E96FC] text-2xl md:text-[55px]"
              >
                13년차
              </span>
              <span
                ...
                className="text-[#FFF600] text-small md:text-[25px]"
              >
                SINCE 2013
              </span>
              <span
                ...
                className="text-[#FFFFFF] text-2xl md:text-[55px] "
              >
                공식 대리점
              </span>
            </p>
          </div>
          <div style={{ fontFamily: "GongGothicMedium" }} className="pl-[3%] text-medium md:text-3xl text-black border-sky-700 border-solid h-12 md:h-24 w-[90%]">
